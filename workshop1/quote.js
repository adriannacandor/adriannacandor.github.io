...
var things = ["Music", "no art", "Dance", "Theater", "Math", "Architecture"];
...
var airs = ["sky", "atmosphere", "heavens", "ether", "love"];
...
q.innerHTML =
    ...
    castles + " in the " + air + ", from " + dusk + ", to dawn " + exertion + " of the imagination.\"" +
